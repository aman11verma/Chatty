...
#Calculating count of each word
...
#Finding words above a certain count threshold
threshold=20
questionswords2int = {}
word_number=0
...
#Translating all questions and answers to int
...
#Sorting questinos and answers by their lengths
...
#Adding SOS at start of each target answer    
...
def decode_training_set(encoder_state,decoder_cell,decoder_embedded_input,sequence_length,decoding_scope,output_function,keep_prob,batch_size):
    ...
    attention_keys,attention_values_attention_score_function,attention_construct_function=tf.contrib.seq2seq.prepare_attention(attention_states,attention_option='bahdanau',num_units=decoder_cell.output_size)
...
def split_into_answers(questions,answers,batch_size):
...
validations_questions=sorted_clean_questions[:training_validation_split]
        ...
        if batch_index % batch_index_check_training_loss == 0 and batch_index > 0 :
            ...
            if average_validation_loss_error <=min(list_validation_loss_error):
                ...
                if early_stopping_check==early_stopping_stop:
                    break
    if early_stopping_check==early_stopping_stop:
        print("My apologies,I cannot speak better,This is the best I can do")
        break
print("Game over")            
